 ...
 * @public
 */
export type ListingPublisher = (typeof ListingPublisherOption)[keyof typeof ListingPublisherOption];
 ...
 * @public
 */
export type MapProvider = (typeof MapProviderOption)[keyof typeof MapProviderOption];
